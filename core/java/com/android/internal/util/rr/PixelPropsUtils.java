...
public class PixelPropsUtils {
    ...
    private static final String DEVICE = "org.rr.device";
    ...
    static {
        ...
        propsToChangePixel6Pro.put("FINGERPRINT", "google/raven/raven:13/TQ1A.221205.011/9244662:user/release-keys");
    ...
    public static void setProps(String packageName) {
        ...
        if (!isPixelDevice &&
            ...
            Map<String, Object> propsToChange = propsToChangePixel6Pro;
